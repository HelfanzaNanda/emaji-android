...
interface ToolContract{
    ...
    fun validateTool(token: String, id : Int, listener : SingleResponse<Tool>)
}
...
class ToolRepository (private val api : ApiService) : ToolContract{
    ...
    override fun validateTool(token: String, id: Int, listener: SingleResponse<Tool>) {
        api.validateTool(token, id).enqueue(object : Callback<WrappedResponse<Tool>>{
